...
from e_store.models import Category, Group, Product, Attribute, Comment
...
class GroupList(generics.ListCreateAPIView):
    ...
    def get_queryset(self):
        return Group.objects.all().select_related('category')
...
class ProductList(generics.ListCreateAPIView):
    ...
    def get_queryset(self):
        return Product.objects.all().select_related('group', 'group__category')
...
class ProductDetailView(generics.RetrieveUpdateDestroyAPIView):
    ...
    def get_queryset(self):
        return Product.objects.all().select_related('group', 'group__category').prefetch_related(
            'images',
            'attributes__key',
            'attributes__value',
            'comments__user',
    ...
    def get_serializer_context(self):
        ...
        if obj:
            ...
            context['all_images'] = [request.build_absolute_uri(image.image.url) for image in obj.images.all()]
